...
struct Statistics
{
    ...
    std::size_t parallel_unknown_checks = 0;
    std::size_t parallel_canceled_checks = 0;
    std::size_t parallel_stale_checks = 0;
    std::size_t global_sat_wins = 0;
    std::size_t chunk_sat_wins = 0;
    std::size_t global_unsat_wins = 0;
    std::size_t chunk_certificate_completions = 0;
    std::size_t zero_singleton_checks = 0;
    std::size_t zero_singleton_sat = 0;
    std::size_t zero_singleton_unsat = 0;
    std::size_t zero_singleton_unknown = 0;
    std::size_t parallel_fallback_checks = 0;
    std::size_t parallel_fallback_sat = 0;
    std::size_t parallel_fallback_unsat = 0;
    std::size_t parallel_fallback_unknown = 0;
    ...
    std::chrono::nanoseconds zero_singleton_time{0};
    std::chrono::nanoseconds parallel_fallback_time{0};
